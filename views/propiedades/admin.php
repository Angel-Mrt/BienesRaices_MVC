<main class="contenedor seccion">
    ...
    <a href="/nosotros/actualizar" class="boton boton-amarillo">Actualizar Sec. Nosotros</a>
    <a href="/blog/admin" class="boton boton-verde">Editar Blog</a>
    <h2>Propiedades</h2>
    ...
    <div class="tabla-container">
        <table class="propiedades" id="vendedores">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Nombre</th>
