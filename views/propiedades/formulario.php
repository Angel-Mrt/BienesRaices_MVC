        <fieldset>
            ...
            <input type="file" id="imagen" accept="image/jpeg, image/png" name="propiedad[imagen]" onchange="visualizarImagen(event)">
            <div id="previewImagen" class="imagen-small"></div>
            <?php if ($propiedad->imagen) : ?>
                <img src="../../imagenes/<?php echo $propiedad->imagen ?>" class="imagen-small" alt="" id="imagen_existente">
            <?php endif; ?>
